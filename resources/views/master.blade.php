        ...
        <div class="d-flex flex-row flex-column-fluid page">
            ...
            <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                        ...
                        <ul class="menu-nav">
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('custom/apps/user/list-default.html')}}" class="menu-link">
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('custom/apps/user/list-datatable.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('custom/apps/user/list-columns-1.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('custom/apps/user/list-columns-2.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('custom/apps/user/add-user.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('custom/apps/user/edit-user.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                                        ...
                                                        <div class="menu-submenu">
                                                            ...
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="{{asset('custom/apps/profile/profile-1/overview.html')}}" class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
																				<span></span>
																			</i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="{{asset('custom/apps/profile/profile-1/personal-information.html')}}" class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
																				<span></span>
																			</i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="{{asset('custom/apps/profile/profile-1/account-information.html')}}" class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
																				<span></span>
																			</i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="{{asset('custom/apps/profile/profile-1/change-password.html')}}" class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
																				<span></span>
																			</i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="{{asset('custom/apps/profile/profile-1/email-settings.html')}}" class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
																				<span></span>
																			</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('custom/apps/profile/profile-2.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('custom/apps/profile/profile-3.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('custom/apps/profile/profile-4.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('custom/apps/inbox.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-line">
														<span></span>
													</i>
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('custom/pages/login/login-1.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('custom/pages/login/login-2.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                                        ...
                                                        <div class="menu-submenu">
                                                            ...
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="{{asset('custom/pages/login/login-3/signup.html')}}" class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
																				<span></span>
																			</i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="{{asset('custom/pages/login/login-3/signin.html')}}" class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
																				<span></span>
																			</i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="{{asset('custom/pages/login/login-3/forgot.html')}}" class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-dot">
																				<span></span>
																			</i>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('custom/pages/wizard/wizard-1.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('custom/pages/wizard/wizard-2.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('custom/pages/wizard/wizard-3.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('custom/pages/wizard/wizard-4.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('custom/pages/wizard/wizard-5.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('custom/pages/pricing/pricing-1.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('custom/pages/pricing/pricing-2.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('custom/pages/invoices/invoice-1.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('custom/pages/invoices/invoice-2.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('custom/pages/error/error-1.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('custom/pages/error/error-2.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('custom/pages/error/error-3.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('custom/pages/error/error-4.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('layout/themes/aside-light.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('layout/themes/header-dark.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('layout/subheader/general.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('layout/subheader/toolbar.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('layout/subheader/actions.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('layout/subheader/crud.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('layout/subheader/none.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('layout/general/sidebar.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('layout/general/expanded-sidebar.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('layout/general/fluid-content.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('layout/general/minimized-aside.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('layout/general/no-aside.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('layout/general/empty-page.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('layout/general/fixed-footer.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('layout/general/no-header-menu.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/bootstrap/typography.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/bootstrap/buttons.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/bootstrap/button-group.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/bootstrap/dropdown.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/bootstrap/navs.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/bootstrap/tables.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/bootstrap/progress.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/bootstrap/modal.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/bootstrap/alerts.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/bootstrap/popover.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/bootstrap/tooltip.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/custom/utilities.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/custom/label.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/custom/pulse.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/custom/line-tabs.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/custom/advance-navs.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/custom/timeline.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/custom/pagination.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/custom/symbol.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/custom/overlay.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/custom/spinners.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/custom/iconbox.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/custom/callout.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/custom/ribbons.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/custom/accordions.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/controls/base.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/controls/input-group.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/controls/checkbox.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/controls/radio.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/controls/switch.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/controls/option.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/widgets/bootstrap-datepicker.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/widgets/bootstrap-datetimepicker.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/widgets/bootstrap-timepicker.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/widgets/bootstrap-daterangepicker.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/widgets/tagify.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/widgets/bootstrap-touchspin.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/widgets/bootstrap-maxlength.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/widgets/bootstrap-switch.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                            <span class="menu-text">Switch</span>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/widgets/bootstrap-multipleselectsplitter.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/widgets/bootstrap-select.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/widgets/select2.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/widgets/typeahead.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/widgets/nouislider.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/widgets/form-repeater.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/widgets/ion-range-slider.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/widgets/input-mask.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/widgets/autosize.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/widgets/clipboard.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/widgets/recaptcha.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/editors/tinymce.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                                        ...
                                                        <div class="menu-submenu">
                                                            ...
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="{{asset('features/forms/editors/ckeditor-classic.html')}}" class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
																				<span></span>
																			</i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="{{asset('features/forms/editors/ckeditor-inline.html')}}" class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
																				<span></span>
																			</i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="{{asset('features/forms/editors/ckeditor-balloon.html')}}" class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
																				<span></span>
																			</i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="{{asset('features/forms/editors/ckeditor-balloon-block.html')}}" class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
																				<span></span>
																			</i>
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="{{asset('features/forms/editors/ckeditor-document.html')}}" class="menu-link">
                                                                        <i class="menu-bullet menu-bullet-line">
																				<span></span>
																			</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/editors/quill.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/editors/summernote.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/editors/bootstrap-markdown.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/layouts/default-forms.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/layouts/multi-column-forms.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/layouts/action-bars.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/layouts/sticky-action-bar.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/validation/states.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/validation/form-controls.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                            <span class="menu-text">Form Controls</span>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/forms/validation/form-widgets.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                            <span class="menu-text">Form Widgets</span>
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/ktdatatable/base/data-local.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/ktdatatable/base/data-json.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/ktdatatable/base/data-ajax.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/ktdatatable/base/html-table.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/ktdatatable/base/local-sort.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/ktdatatable/base/translation.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/ktdatatable/advanced/record-selection.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/ktdatatable/advanced/row-details.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/ktdatatable/advanced/modal.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/ktdatatable/advanced/column-rendering.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/ktdatatable/advanced/column-width.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/ktdatatable/advanced/vertical.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/ktdatatable/child/data-local.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                            <span class="menu-text">Local Data</span>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/ktdatatable/child/data-ajax.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/ktdatatable/api/methods.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/ktdatatable/api/events.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/datatables/basic/basic.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/datatables/basic/scrollable.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/datatables/basic/headers.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/datatables/basic/paginations.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/datatables/advanced/column-rendering.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                            <span class="menu-text">Column Rendering</span>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/datatables/advanced/multiple-controls.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/datatables/advanced/column-visibility.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/datatables/advanced/row-callback.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/datatables/advanced/row-grouping.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/datatables/advanced/footer-callback.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/datatables/data-sources/html.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/datatables/data-sources/javascript.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/datatables/data-sources/ajax-client-side.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/datatables/data-sources/ajax-server-side.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/datatables/search-options/column-search.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/datatables/search-options/advanced-search.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/datatables/extensions/buttons.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                            <span class="menu-text">Buttons</span>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/datatables/extensions/colreorder.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/datatables/extensions/keytable.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/datatables/extensions/responsive.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/datatables/extensions/rowgroup.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/datatables/extensions/rowreorder.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/datatables/extensions/scroller.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/datatables/extensions/select.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/file-upload/image-input.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/file-upload/dropzonejs.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/file-upload/uppy.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/cards/general.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/cards/stacked.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/cards/tabbed.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/cards/draggable.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/cards/tools.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/cards/sticky.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/cards/stretched.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/widgets/lists.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/widgets/stats.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/widgets/charts.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/widgets/mixed.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/widgets/tables.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                                <span class="menu-text">Tables</span>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/widgets/nav-panels.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/widgets/engage.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/icons/svg.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/icons/custom-icons.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/icons/flaticon.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/icons/fontawesome5.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/icons/lineawesome.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/icons/socicons.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/calendar/basic.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/calendar/list-view.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/calendar/google.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/calendar/external-events.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/calendar/background-events.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/charts/apexcharts.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/charts/amcharts/charts.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/charts/amcharts/stock-charts.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{asset('features/charts/amcharts/maps.html')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/charts/flotcharts.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/charts/google-charts.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/maps/google-maps.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/maps/leaflet.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/maps/jqvmap.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/miscellaneous/kanban-board.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/miscellaneous/sticky-panels.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/miscellaneous/blockui.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/miscellaneous/perfect-scrollbar.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/miscellaneous/treeview.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/miscellaneous/bootstrap-notify.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/miscellaneous/toastr.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/miscellaneous/sweetalert2.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/miscellaneous/dual-listbox.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/miscellaneous/session-timeout.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/miscellaneous/idle-timer.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{asset('features/miscellaneous/cropper.html')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                ...
                <!--end::Aside Menu-->
                 ...
                 <!--begin::Aside Menu-->
                 <h2 class="text-light text-center mt-5">{{session('name')}}</h2>
                 <span class="text-light text-center">Admin</span>
                        ...
                        <ul class="menu-nav">
                            <li class="menu-item" aria-haspopup="true">
                                <a href="" class="menu-link">
                                    <span class="svg-icon menu-icon svg-icon-primary svg-icon-2x"><i class="fa fa-home"></i></span>
                                    <span class="menu-text">Dashboard</span>
                                </a>
                            </li>
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{Route('product')}}" class="menu-link">
                                    <span class="svg-icon menu-icon svg-icon-primary svg-icon-2x"><i class="fa fa-shopping-cart"></i></span>
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{Route('order.show')}}" class="menu-link">
                                    <span class="svg-icon menu-icon svg-icon-primary svg-icon-2x"><i class="fa fa-info"></i></span>
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{Route('category')}}" class="menu-link">
                                    <span class="svg-icon menu-icon svg-icon-primary svg-icon-2x"><i class="fa fa-id-badge"></i></span>
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{Route('logout')}}" class="menu-link">
                                    <span class="svg-icon menu-icon svg-icon-primary svg-icon-2x"><i class="fa fa-power-off"></i></span>
                        ...
                        <div class="topbar">
                            ...
                            <div class="topbar-item ml-4">
                                <div class="btn btn-icon btn-light-primary h-40px w-40px p-0" id="kt_quick_user_toggle">
                                    <img src="{{URL::asset(session('admin_image_name'))}}" class="h-40px align-self-end rounded" alt="" />
                                </div>
                                <!--
                            ...
                            <div class="timeline-items">
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-info h-100">
                                        ...
                                        <p class="font-weight-normal text-dark-50 pb-2">Many desktop publishing packages and web page editors now use Lorem Ipsum.</p>
                                    </div>
                                    <!--end::Info-->
                                </div>
                                <!--end::Item-->
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-info">
                                        ...
                                        <p class="font-weight-normal text-dark-50 pt-1 pb-2">There are many variations of passages of Lorem Ipsum available.</p>
                                    </div>
                                    <!--end::Info-->
                                </div>
                                <!--end::Item-->
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-info">
                                        ...
                                        <p class="font-weight-normal text-dark-50 pt-1">Latin words, combined with a handful of model sentence structures.</p>
                                    </div>
                                    <!--end::Info-->
                                </div>
                                <!--end::Item-->
