...
<body>
    ...
    <header class="header-section">
        ...
        <div class="container-fluid" style="background-color: rgba(218, 245, 245, 0.8)">
            <div class="inner-header p-0">
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="logo d-flex justify-content-center align-item-center float-left">
                    ...
                    <div class="col-lg-6 text-right col-md-6">
                        <ul class="nav-right">
                            ...
                            <img src="{{ URL::asset($details['image']) }}" width="50"
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="footer-left">
                        ...
                        <ul>
                            <li>Address: 49 Road jinnah avenue Karachi Pakistan</li>
                            <li>Phone: +923112553083</li>
                            <li>Email: sheikh.ebad6@gmail.com</li>
                        </ul>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <script>
        document.getElementById("mendefaultOpen").click();
    </script>
    <script>
        document.getElementById("kiddefaultOpen").click();
    </script>
