    ...
    <section class="product-shop spad">
        <div class="container">
            ...
            <div style="border-bottom: black 1px solid; margin: 25px 0px; display: flex; justify-content: center">
                <h3 style="color: #dfad51">Kid Shoes Section</h3>
            </div>
                <div class="row">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="{{ URL::asset($kid_shoes->product_image_path.$kid_shoes->product_image_name) }}" style="height: 350px;" alt="Women's Img">
                            <ul>
                ...
                <div class="row">
                    @foreach ($kid_accessory as $items)
                <div class="col-lg-3 col-sm-6">
                    <div class="product-item">
                        <div class="pi-pic">
