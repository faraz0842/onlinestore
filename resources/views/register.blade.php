            ...
            <div class="login-body d-flex flex-column-fluid align-items-stretch justify-content-center">
                <div class="container row">
                            ...
                            <form class="form w-xxl-550px rounded-lg p-20" novalidate="novalidate"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-solid h-auto p-6 rounded-lg" type="text"
                                        value="{{old('name')}}" name="name" autocomplete="on" />
                                    @if ($errors->has('name'))
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-solid h-auto p-6 rounded-lg" type="text"
                                    value="{{old('email')}}" name="email" autocomplete="on" />
                                    @if ($errors->has('email'))
                                ...
                                <!--begin::Form group-->
                                <div class="form-group">
                                    <label class="font-size-h6 font-weight-bolder text-dark">Conatct Number</label>
                                    <input class="form-control form-control-solid h-auto p-6 rounded-lg" type="phone"
                                    value="{{old('contact_number')}}"  name="contact_number" autocomplete="on" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-solid h-auto p-6 rounded-lg" type="text"
                                    value="{{old('address')}}" name="address" autocomplete="on" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-solid h-auto p-6 rounded-lg" type="text"
                                    value="{{old('city')}}" name="city" autocomplete="on" />
                                    @if ($errors->has('city'))
                                ...
                                <div class="pb-lg-0 pb-5">
                                    <button type="submit" id="kt_login_signin_submit"
                                        class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">Register
                                        </button>
                                    <button type="button"
                    ...
                    <div class="col-lg-6 bgi-size-contain bgi-no-repeat bgi-position-y-center bgi-position-x-center min-h-150px mt-10 m-md-0"
                        style="background-image: url(assets/media/svg/illustrations/accomplishment.svg)"></div>
                </div>
            </div>
            <!--end::Body-->
            <!--begin::Footer-->
                ...
                <div
                    ...
                    <div class="font-size-h6 font-weight-bolder order-2 order-md-1 py-2 py-md-0">
                        ...
                        <a href="https://keenthemes.com/keen" target="_blank"
                            class="text-dark-50 text-hover-primary">Keenthemes</a>
                    </div>
